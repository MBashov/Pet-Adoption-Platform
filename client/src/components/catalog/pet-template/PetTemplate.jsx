...
export default function PetTemplate({ pet }) {
    ...
    return (
        <div className="w-80 h-auto p-6 shadow-lg rounded-lg bg-white text-center transform hover:scale-105 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mt-2">{pet.breed} - {pet.age} {pet.age > 1 ? 'Years' : 'Year'} Old</p>
